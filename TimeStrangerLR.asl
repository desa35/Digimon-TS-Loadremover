...
startup
{
	...
	vars.resetOK = false; // Used to stop the timer from continuously resetting.
...
split
{
	...
	if (old.mission == 110 && current.mission == 4294967295 && vars.splitHere) { return true; }
	...
	if (current.music == 214 && vars.splitHere) { vars.splitHere = false; }
	...
	if (settings["metalGrey"] && vars.metalGreyHP.Contains(current.bossHP) && vars.metalGreyHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["kuwaga"] && vars.kuwagaHP.Contains(current.bossHP) && vars.kuwagaHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["rare"] && vars.rareHP.Contains(current.bossHP) && vars.rareHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["vade"] && vars.vadeHP.Contains(current.bossHP) && vars.vadeHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["cyclone"] && vars.cycloneHP.Contains(current.bossHP) && vars.cycloneHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["grey"] && vars.greyHP.Contains(current.bossHP) && vars.greyHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["blackCat"] && vars.blackCatHP.Contains(current.bossHP) && vars.blackCatHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["tita"] && vars.titaHP.Contains(current.bossHP) && vars.titaHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["ogreSewers"] && vars.ogreSewersHP.Contains(current.bossHP) && vars.ogreSewersHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["parrot"] && vars.parrotHP.Contains(current.bossHP) && vars.parrotHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	...
	if (settings["shark"] && vars.sharkHP.Contains(current.bossHP) && vars.sharkHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["okuwa"] && vars.okuwaHP.Contains(current.bossHP) && vars.okuwaHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["tyrantDungeon"] && vars.tyrantDungeonHP.Contains(current.bossHP) && vars.tyrantDungeonHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["ogrePalace"] && vars.ogrePalaceHP.Contains(current.bossHP) && vars.ogrePalaceHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["coredra"] && vars.coredraHP.Contains(current.bossHP) && vars.coredraHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	...
	if (settings["skull"] && vars.skullHP.Contains(current.bossHP) && vars.skullHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["lana"] && vars.lanaHP.Contains(current.bossHP) && vars.lanaHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["calmara"] && vars.calmaraHP.Contains(current.bossHP) && vars.calmaraHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["witch"] && vars.witchHP.Contains(current.bossHP) && vars.witchHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["tyrantBoss"] && vars.tyrantBossHP.Contains(current.bossHP) && vars.tyrantBossHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["grap"] && vars.grapHP.Contains(current.bossHP) && vars.grapHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["callis"] && vars.callisHP.Contains(current.bossHP) && vars.callisHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["venom"] && vars.venomHP.Contains(current.bossHP) && vars.venomHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["zombie"] && vars.zombieHP.Contains(current.bossHP) && vars.zombieHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["kuga"] && vars.kugaHP.Contains(current.bossHP) && vars.kugaHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["apollo"] && vars.apolloHP.Contains(current.bossHP) && vars.apolloHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["diana"] && vars.dianaHP.Contains(current.bossHP) && vars.dianaHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["sora"] && vars.soraHP.Contains(current.bossHP) && vars.soraHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["juno"] && vars.junoHP.Contains(current.bossHP) && vars.junoHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["giant"] && vars.giantHP.Contains(current.bossHP) && vars.giantHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["barba"] && vars.barbaHP.Contains(current.bossHP) && vars.barbaHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["creepy"] && vars.creepyHP.Contains(current.bossHP) && vars.creepyHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["lilith"] && vars.lilithHP.Contains(current.bossHP) && vars.lilithHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["levia"] && vars.leviaHP.Contains(current.bossHP) && vars.leviaHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["luce"] && vars.luceHP.Contains(current.bossHP) && vars.luceHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["beelze"] && vars.beelzeHP.Contains(current.bossHP) && vars.beelzeHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	if (settings["belphe"] && vars.belpheHP.Contains(current.bossHP) && vars.belpheHP.Contains(current.music) && !vars.splitHere) { vars.splitHere = true; }
	...
	if (settings["ch10"] && old.mission < current.mission) { return true; }
	if (settings["ch20"] && old.mission < current.mission) { return true; }
	if (settings["ch30"] && old.mission < current.mission) { return true; }
	if (settings["ch40"] && old.mission < current.mission) { return true; }
	if (settings["ch50"] && old.mission < current.mission) { return true; }
	if (settings["ch60"] && old.mission < current.mission) { return true; }
	if (settings["ch70"] && old.mission < current.mission) { return true; }
	if (settings["ch80"] && old.mission < current.mission) { return true; }
	if (settings["ch90"] && old.mission < current.mission) { return true; }
	if (settings["ch100"] && old.mission < current.mission) { return true; }
	if (settings["ch110"] && old.mission < current.mission) { return true; }
	if (settings["ch120"] && old.mission < current.mission) { return true; }
	if (settings["ch130"] && old.mission < current.mission) { return true; }
	if (settings["ch140"] && old.mission < current.mission) { return true; }
	if (settings["ch150"] && old.mission < current.mission) { return true; }
	if (settings["ch160"] && old.mission < current.mission) { return true; }
	if (settings["ch170"] && old.mission < current.mission) { return true; }
	if (settings["ch180"] && old.mission < current.mission) { return true; }
	if (settings["ch190"] && old.mission < current.mission) { return true; }
	if (settings["ch200"] && old.mission < current.mission) { return true; }
	if (settings["ch210"] && old.mission < current.mission) { return true; }
	if (settings["ch220"] && old.mission < current.mission) { return true; }
	if (settings["ch230"] && old.mission < current.mission) { return true; }
	if (settings["ch235"] && old.mission < current.mission) { return true; }
	if (settings["ch240"] && old.mission < current.mission) { return true; }
	if (settings["ch250"] && old.mission < current.mission) { return true; }
	if (settings["ch260"] && old.mission < current.mission) { return true; }
	if (settings["ch280"] && old.mission < current.mission) { return true; }
	if (settings["ch285"] && old.mission < current.mission) { return true; }
	if (settings["ch290"] && old.mission < current.mission) { return true; }
	if (settings["ch300"] && old.mission < current.mission) { return true; }
	if (settings["ch310"] && old.mission < current.mission) { return true; }
	if (settings["ch320"] && old.mission < current.mission) { return true; }
	if (settings["ch330"] && old.mission < current.mission) { return true; }
	if (settings["ch340"] && old.mission < current.mission) { return true; }
	if (settings["ch350"] && old.mission < current.mission) { return true; }
	if (settings["ch360"] && old.mission < current.mission) { return true; }
	if (settings["ch390"] && old.mission < current.mission) { return true; }
	if (settings["ch400"] && old.mission < current.mission) { return true; }
	if (settings["ch410"] && old.mission < current.mission) { return true; }
	if (settings["ch420"] && old.mission < current.mission) { return true; }
	if (settings["ch440"] && old.mission < current.mission) { return true; }
